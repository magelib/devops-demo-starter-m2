...
class Payment extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $isPayLater = $this->scopeConfig->getValue('payment/'.$code.'/use_reference_number', ScopeInterface::SCOPE_STORE);
        return $isPayLater;
    }
    ...
    {
        $isPayLater = $this->scopeConfig->getValue('webpos/payment/paypal/enable', ScopeInterface::SCOPE_STORE);
        return $isPayLater;
    }
