...
class Config extends \Magento\Framework\Model\AbstractModel implements \Magestore\Webpos\Model\WebposConfigProvider\ConfigProviderInterface {
    ...
    public function setConfigPaths() {
        $configurations = [
            ...
            'receipt/general/auto_print','receipt/content/font_type','receipt/content/header_text','receipt/content/footer_text',
            'receipt/optional/show_receipt_logo', 'receipt/optional/show_cashier_name','receipt/optional/show_comment',
            'shipping/enable_mark_as_shipped_default', 'general/enable_session', 'general/confirm_delete_order', 'general/active_key',
            'general/custom_sale_default_tax_class'
        ];
