...
class Index extends \Magestore\Webpos\Controller\Adminhtml\Report\AbstractReport
{
    ...
    public function execute()
    {
        $this->_initAction()->_setActiveMenu(
            ...
            __('Sales by location'),
            __('Sales by location')
        );
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales by location'));

        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_report_salelocation.grid');
