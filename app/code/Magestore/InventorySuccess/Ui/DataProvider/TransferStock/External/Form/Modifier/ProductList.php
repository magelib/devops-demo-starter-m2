...
class ProductList extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\External\Form\Modifier\ExternalStock
{
    ...
    public function modifyData(array $data)
    {
        ...
        if ($transferstock_id) {
            ...
            $request_products =   $locator->getSesionByKey("external_products");
            ...
            if(count($request_products)){
                ...
                if($transferStock->getType() == TransferStockInterface::TYPE_FROM_EXTERNAL){
                    $products = $collection->addFieldToFilter("transferstock_id",$transferstock_id);
                }
                else{
                    $products = $collection->getTransferStockProduct($transferstock_id, $warehouseId);
                }
        ...
        $locator->refreshSessionByKey("external_products");
        return $data;
    }
    ...
    public function getTransferStockProducts(){
        ...
        if($transferStock->getType() == TransferStockInterface::TYPE_TO_EXTERNAL ){
    ...
    public function isShowColumnHeader(){
        ...
        if ($transferstock_id) {
            ...
            /** \Magestore\InventorySuccess\Model\ResourceModel\TransferStock\TransferStockProduct\CollectionFactory */
            $external_products =   $locator->getSesionByKey("external_products");
