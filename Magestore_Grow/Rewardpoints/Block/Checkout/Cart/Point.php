...
class Point extends \Magento\Framework\View\Element\Template
{
    ...
    public function checkMaxpoint() {
        if($this->_helperCustomer->getBalance() && $this->_calculationSpending->isUseMaxPointsDefault() && (!$this->_calculationSpending->isUsePoint() || $this->_checkoutSessionFactory->create()->getData('use_max'))){
            return 1;
        }else{
            return 0;
        }
