...
class Spending extends \Magento\Sales\Block\Adminhtml\Order\Create\AbstractCreate
{
     ...
     * Sales config
     *
     * @var \Magento\Sales\Model\ConfigFactory
     */
    protected $_salesConfigFactory;
     ...
     * @param \Magento\Sales\Model\ConfigFactory $salesConfigFactory
     * @param array $data
     */
    public function __construct(
        ...
        \Magento\Sales\Model\ConfigFactory $salesConfigFactory,
        array $data = []
    ) {
        $this->_salesData = $salesData;
        $this->_salesConfigFactory = $salesConfigFactory;
    ...
    protected function _getTotalRenderer($code)
    {
        ...
        if (!$block) {
            $configRenderer = $this->_salesConfigFactory->create()->getTotalsRenderer('quote', 'totals', $code);
