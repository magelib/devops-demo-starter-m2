...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $data[0]['design_pattern'] = \Magestore\Giftvoucher\Model\Source\DesignPattern::PATTERN_LEFT;
        ...
        $data[1]['design_pattern'] = \Magestore\Giftvoucher\Model\Source\DesignPattern::PATTERN_TOP;
        
        $data[2]['template_name'] = __('Default Template 3');
        $data[2]['style_color'] = '#DC8C71';
        $data[2]['text_color'] = '#A9A7A7';
        $data[2]['caption'] = __('Gift Card');
        $data[2]['notes'] = '';
        $data[2]['images'] = 'default.png';
        $data[2]['background_img'] = 'default.png';
        $data[2]['design_pattern'] = \Magestore\Giftvoucher\Model\Source\DesignPattern::PATTERN_CENTER;
