 ...
 */
class StockSummary extends \Magestore\InventorySuccess\Ui\DataProvider\TransferStock\Send\Form\Modifier\SendStock
{
    ...
    protected $_modifierConfig = [
        ...
        'history_listing' => 'transferstock_send_stock_summary',
        'columns_ids' => 'id'
    ];
    ...
    public function getVisible(){
        ...
        if($transferstock_id){
            ...
            if(($transferStock->getStatus() == TransferStock::STATUS_PROCESSING ) ||($transferStock->getStatus() == TransferStock::STATUS_COMPLETED)){
                return true;
            }
        }
