...
class DefaultConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $output['currentCurrencySymbol'] = $this->_objectManager->get('Magento\Directory\Model\Currency')->load($output['currentCurrencyCode'])->getCurrencySymbol();
        ...
        $output['enable_pole_display'] = $this->_permissionHelper->isEnablePoleDisplay();
